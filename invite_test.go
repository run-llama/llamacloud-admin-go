...
func TestInviteListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Invites.List(context.TODO(), llamacloudadmin.InviteListParams{
...
func TestInviteDelete(t *testing.T) {
	...
	err := client.Invites.Delete(context.TODO(), "invite_id")
	if err != nil {
		var apierr *llamacloudadmin.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestInviteAccept(t *testing.T) {
	...
	_, err := client.Invites.Accept(context.TODO(), "invite_id")
	if err != nil {
		var apierr *llamacloudadmin.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
