...
func TestUserAgentHeader(t *testing.T) {
	...
	_, _ = client.Organizations.List(context.Background(), llamacloudadmin.OrganizationListParams{})
	if userAgent != fmt.Sprintf("LlamaCloudAdmin/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Organizations.List(context.Background(), llamacloudadmin.OrganizationListParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Organizations.List(cancelCtx, llamacloudadmin.OrganizationListParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Organizations.List(deadlineCtx, llamacloudadmin.OrganizationListParams{})
		if err == nil {
