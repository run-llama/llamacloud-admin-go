...
// RequestOption is an option for the requests made by the llama-cloud-admin API Client
...
func WithEnvironmentProduction() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://api.cloud.llamaindex.ai/")
}
